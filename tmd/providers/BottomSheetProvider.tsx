...
export type PermissionType =
  "camera" | "storage" | "location" | "bluetooth" | "contact" | "notification" | "another";
...
const BottomSheetProvider = ({ children }: any) => {
  ...
  const showErrorBS = (error: any, props?: ConfirmationBSContext) => {
    ...
    } else if (error?.error?.message == "Your account is blocked.") {
      data = {
        title: t("errors.account_blocked_title"),
        description: t("errors.account_blocked_description"),
        buttonPrimaryTitle: t("understand"),
        buttonPrimaryAction: () => {
          hideErrorBS();
        },
        dismissible: false,
  ...
  const renderComponent = () => {
    return <>
      <ConfirmationBottomSheet
        ...
        {...confirmationProps}
        isLoading={confirmationProps.isLoading}
      />
